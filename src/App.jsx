	...
	return (<div>
		<section className={cn(css.section, css.mainSection)}>
			<div className={cn(css.topContainer, 'noPrint')}>
				<div className={css.titleContainer}>
					<i className="fa fa-cutlery"/>Meal Planner
				</div>
		...
		<footer className={cn(css.footer, 'noPrint')}>
			<div className={css.socialContainer}>
				...
				<a className={css.linkItem} href="mailto:meal@planner.com" target="_blank"><i className="fa fa-at" aria-hidden="true"/>Contact us</a>
